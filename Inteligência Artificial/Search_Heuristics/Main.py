...
from Local.Neighbourhood.VizinhancaNodeSwap import VizinhancaNodeSwap
...
autoria = "Allex Antoniollo & Gustavo da Fonseca Roza"
...
def main():
    for idx, arquivo in enumerate(arquivos):
        ...
        algoritmos = (
            ...
            BuscaLocalMelhorMelhora(VizinhancaNodeSwap(distancias), solucao_otima),  # Mudar nome para a Vizinhanca implementada
            ...
            BuscaLocalPrimeiraMelhora(VizinhancaNodeSwap(distancias), solucao_otima),  # Mudar nome para a Vizinhanca implementada
            BuscaTabu(Vizinhanca2opt(distancias), solucao_otima, 3),
            BuscaTabu(VizinhancaShift(distancias), solucao_otima, 3),
            BuscaTabu(VizinhancaNodeSwap(distancias), solucao_otima, 3),  # Mudar nome para a Vizinhanca implementada
            BuscaTabu(Vizinhanca2opt(distancias), solucao_otima, 5),
            BuscaTabu(VizinhancaShift(distancias), solucao_otima, 5),
            BuscaTabu(VizinhancaNodeSwap(distancias), solucao_otima, 5),  # Mudar nome para a Vizinhanca implementada
            )
